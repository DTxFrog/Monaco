...
# Dynatrace API token - Check prerequisite here (https://www.dynatrace.com/support/help/shortlink/configuration-as-code-manage-configuration#prerequisites) to see which scopes are required
export DT_URL="https://zcv91593.sprint.dynatracelabs.com/"        # Add your Dynatrace Tenant URL - e.g. https://<tenantId>.apps.dynatrace.com/
...
export MW_DESCRIPTION="Subject Service planned maintenance"
